...
class ProductsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('products')->insert([
            ...
            [
                'category' => 'Cooling',
                'name' => 'NEX AquaForce Pro',
                'info' => 'Il NEX AquaForce Pro offre raffreddamento a liquido di qualità premium con un radiatore da 240 mm, compatto e versatile. Grazie alle ventole PWM e a un flusso d\'acqua ottimizzato, assicura una gestione termica eccellente per i sistemi di fascia alta e i PC da gaming. Ideale per le CPU NEX CoreX7.',
                'image' => 'images/Cooling/NEX AquaForce Pro.png'
            ],
            [
                'category' => 'Cooling',
